...
class SelectSheetToggle extends StatefulWidget {
  ...
  /// Builds the trigger with the current open state and the tap callback that
  /// maintains it. Pass `onTap` on rather than [widget.onTap], or the state
  /// never flips.
  // Positional bool: this mirrors ValueListenableBuilder's own builder shape.
