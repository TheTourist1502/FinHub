...
class _MultiSelectItemState<T> extends State<MultiSelectItem<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      color: _selected ? theme.colorScheme.primary.withValues(alpha: 0.07) : Colors.transparent,
      child: InkWell(
            ...
            children: [
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(AppDimensions.borderRadiousSx + 1),
                  color: _selected ? theme.colorScheme.primary : Colors.transparent,
                  border: Border.all(
                    color: _selected ? theme.colorScheme.primary : context.appColors.borderDefault,
              ...
              Expanded(
                child: Text(
                  ...
                  style: AppTypography.bodyMedium.copyWith(
                    ...
                    color: _selected ? theme.colorScheme.primary : theme.colorScheme.onSurface,
                  ),
                ),
              ),
            ],
